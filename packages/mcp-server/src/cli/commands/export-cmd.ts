...
export const exportCommand = defineCommand({
  meta: { name: "export", description: "Export a specification document to xlsx, pdf, or docx" },
  args: {
    format: { type: "string", required: true, description: "Export format: xlsx, pdf, docx" },
    "doc-type": { type: "string", required: true, description: "Document type (e.g. requirements)" },
    output: { type: "string", required: true, description: "Output file path (.xlsx/.pdf/.docx)" },
