...
| 要件定義書 | 機能一覧 | 基本設計書 (画面) | 基本設計書 (テーブル) | 基本設計書 (API) |
|----------|---------|---------------|------------------|----------------|
...
1. 要件定義書 modified → check 機能一覧 and downstream impact
...
1. **Always generate in order:** 要件定義書 → 機能一覧 → 基本設計書
