---
name: sekkei-rfp
description: "Presales RFP lifecycle command. Receive RFP → analyze → Q&A → proposal → scope freeze. Resumable, deterministic, file-based."
version: 2.0.0
---
...
|-------|------|----------------|
| **Entrypoint** | `command.md` (this) | Routing, UX, delegation |
| **State** | `manager.md` | Workspace, files, persistence, resume |
...
See `manager.md` for phase enum, transition rules, and file write rules.
See `rfp-loop.md` for analysis flow details.
