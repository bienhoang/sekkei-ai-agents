...
| Lệnh | Dùng khi nào |
|------|--------------|
| `sekkei init` | Khởi tạo project mới, tạo `sekkei.config.yaml` |
...
- [ ] `sekkei doctor` chạy OK — tất cả components healthy
